...
// Bug: Mobile displays top left corner and on bob
...
//    obj.animate({"opacity": 1, "top": "-=125px"}, 1000, "linear", function() {
//	$(this).remove();	
//	});
//});//]]> 
// Fix mobile bug
...
['click', 'touchstart'].forEach(function(e){
    ...
    ['click', 'touchstart'].forEach(function(e){
      document.getElementById("closemenux").addEventListener(e,CLOSEshop);
    });
    ['click', 'touchstart'].forEach(function(e){
      document.getElementById("defaultOpen").addEventListener(e, function(){ 
      openCity(event, 'Shop')
 }, false);});
     ['click', 'touchstart'].forEach(function(e){
      document.getElementById("menuUP").addEventListener(e, function(){ 
      openCity(event, 'Upgrade')
 }, false);});
     ['click', 'touchstart'].forEach(function(e){
